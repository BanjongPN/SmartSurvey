...
class _ShowStatusFoodOrderState extends State<ShowStatusFoodOrder> {
        ...
        children: [
          Expanded(
            ...
            child: Row(
              ...
              children: [
                MyStyle().showTitleH3Red('รวมราคารังวัด '),
              ],
            ),
          ),
          Expanded(
    ...
    return Container(
      ...
      child: Row(
        children: [
          Expanded(
            flex: 3,
            child: MyStyle().showTitleH3White('รายการรังวัด'),
          ),
          Expanded(
            flex: 1,
  ...
  Row buildTransport(int index) {
    return Row(
      children: [
        MyStyle()
            .showTitleH3Purple('ค่าเดินทาง ${orderModels[index].transport} บาท'),
      ],
    );
  }
  ...
  Row buildNameShop(int index) {
    return Row(
      children: [
        MyStyle().showTitleH2('ที่ ${orderModels[index].nameShop}'),
      ],
    );
  }

  Center buildNonOrder() =>
      Center(child: Text('ยังไม่เคยมี ข้อมูลการแจ้งรังวัด'));
