...
class _EditFoodMenuState extends State<EditFoodMenu> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('ปรับปรุง รายการ ${foodModel.nameFood}'),
      ),
  ...
  Future<Null> confirmEdit() async {
    showDialog(
      ...
      builder: (context) => SimpleDialog(
        title: Text('คุณต้องการจะ เปลี่ยนแปลง รายการ ...?'),
        children: <Widget>[
          Row(
            children: <Widget>[
              FlatButton.icon(
        ...
        children: <Widget>[
          Container(
            ...
            child: TextFormField(
              ...
              initialValue: detail,
              decoration: InputDecoration(
                labelText: 'รายละเอียด การรังวัด',
                border: OutlineInputBorder(),
              ),
            ),
          ),
