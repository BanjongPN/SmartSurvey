...
class _AddFoodMenuState extends State<AddFoodMenu> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('เพิ่มรายการงานสำรวจรังวัด'),
      ),
      body: SingleChildScrollView(
        child: Column(
          children: <Widget>[
            showTitleFood('รูปภาพตัวอย่าง'),
            groupImage(),
            showTitleFood('รายละเอียดงานสำรวจรังวัด'),
            nameForm(),
            MyStyle().mySizebox(),
            priceForm(),
            MyStyle().mySizebox(),
  ...
  Widget nameForm() => Container(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            labelText: 'ประเภทงานสำรวจรังวัด',
  ...
  Widget detailForm() => Container(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            ...
            labelText: 'รายละเอียดงานสำรวจรังวัด',
            border: OutlineInputBorder(),
          ),
        ),
      );
